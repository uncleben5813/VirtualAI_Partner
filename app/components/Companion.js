...
import MayaLiveAvatar from "./MayaLiveAvatar";
...
const STORAGE = {
  messages: "maya_messages_v5",
  mood: "maya_mood_v5",
  memory: "maya_memory_v5",
  settings: "maya_settings_v5",
};
    ...
    <main className="mayaApp">
      ...
      <section className="mayaLiveSection">
        ...
        <div className="mayaLiveContent">
          <MayaLiveAvatar mood={mood} loading={loading} speaking={speaking} listening={listening} reacting={reacting} />
